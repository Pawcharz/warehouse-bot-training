...
def main():
    ...
    try:
        ...
        settings = {
            ...
            'experiment_name': f'ppo_camera_120deg_0_20_100_find_2_items_0_seed_0',
        ...
        try:
            ...
            filename = create_model_filename("ppo_camera_120deg_0_20_100_find_2_items_0_seed_0", seed)
